...
@Client.on_message(filters.private & ~filters.command(['start','users','broadcast','batch','genlink','usage', 'pbroadcast', 'ban', 'unban', 'authorize', 'unauthorize', 'authorized', 'request', 'profile']))
